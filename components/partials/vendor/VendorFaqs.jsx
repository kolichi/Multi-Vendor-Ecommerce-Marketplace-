    ...
    <div className="ps-section--vendor ps-vendor-faqs">
        <div className="container">
            <div className="ps-section__header">
                ...
                <h4>Here are some common questions about selling on TeraStore</h4>
            </div>
            <div className="ps-section__content">
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            <figcaption>How do fees work on TeraStore?</figcaption>
                            <p>
                                Joining and starting a shop on TeraStore is free. There are three
                        ...
                        <figure>
                            ...
                            <p>
                                It’s easy to set up a shop on TeraStore. Create an TeraStore account
                                ...
                                want to pay your TeraStorefees).
                            </p>
                        </figure>
                    </div>
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            ...
                            <p>
                                ...
                                TeraStore will be deposited into your PayPal account. We encourage
                        ...
                        <figure>
                            <figcaption>What can I sell on TeraStore?</figcaption>
                        </figure>
                        <p>
                            TeraStore provides a marketplace for crafters, artists and collectors to
