    ...
    <div className="ps-section--vendor ps-vendor-faqs">
        <div className="container">
            <div className="ps-section__header">
                ...
                <h4>Here are some common questions about selling on Tera-Store</h4>
            </div>
            <div className="ps-section__content">
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            <figcaption>How do fees work on Tera-Store?</figcaption>
                            <p>
                                Joining and starting a shop on Tera-Store is free. There are three
                                basic selling fees: a listing fee, a transaction fee, and a payment
                                processing fee.
                            </p>
                            <p>
                                It costs ZMK 0.20 to publish a listing to the marketplace. A listing
                            ...
                            <p>
                                Listing fees are billed for $0.20 ZMK, so if your bank’s currency is
                                not ZMK, the amount may differ based on changes in the exchange
                                rate.
                            </p>
                        </figure>
                        <figure>
                            ...
                            <p>
                                It’s easy to set up a shop on Tera-Store. Create an Tera-Store account
                                ...
                                want to pay your Tera-Storefees).
                            </p>
                        </figure>
                    </div>
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            ...
                            <p>
                                ...
                                Tera-Store will be deposited into your PayPal account. We encourage
                        ...
                        <figure>
                            <figcaption>What can I sell on Tera-Store?</figcaption>
                        </figure>
                        <p>
                            Tera-Store provides a marketplace for crafters, artists and collectors to
